...
const StudentProfile = () => {
  ...
  const [performanceStudentId, setPerformanceStudentId] = useState<number | null>(null);
      ...
      <div className="w-full">
                    ...
                    <tr key={student.id} className="hover:bg-slate-50/80 transition-colors duration-150">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end gap-3">
                           ...
                           <button
                             onClick={() => setPerformanceStudentId(student.id)}
        ...
        {performanceStudentId && (
           <StudentPerformanceModal 
              userId={performanceStudentId} 
              onClose={() => setPerformanceStudentId(null)} 
           />
        )}
      </div>
    </TeacherLayout>
